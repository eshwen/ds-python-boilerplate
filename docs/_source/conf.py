...
_latest_tag = subprocess.run(['git', 'describe', '--tags'], capture_output=True)
...
add_module_names = False  # Don't render full module paths like client_reports.extractors.sql_extractor.SQLExtractor
...
autodoc_default_options = {
    'exclude-members': ''  # comma-separated class members to ignore
}
